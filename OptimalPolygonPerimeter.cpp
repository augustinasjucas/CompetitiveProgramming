...
int main(){
    ...
    long long sk = 0;
    for(int i = 0; i < n; i++){
        sk += abs(mas[i].first-mas[(i+1)%n].first) + abs(mas[i].second-mas[(i+1)%n].second);
